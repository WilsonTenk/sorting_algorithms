 ...
 *
 * Return: Positive byte dif if s1 > s2
 *         0 if s1 == s2
 *         Negative byte dif if s1 < s2
 */
int _strcmp(const char *s1, const char *s2)
{
	while (*s1 && *s2 && *s1 == *s2)
...
/**
 * get_value - Numerical value of a card.
...
/**
 * insertion_sort_deck_kind - get a deck of cards from spades to diamonds.
...
/**
 * insertion_sort_deck_value - get a deck of cards sorted from
...
/**
 * sort_deck - get a deck of cards from ace to king and
